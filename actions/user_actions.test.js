...
describe('Actions.User', () => {
            ...
            preferences: {
                myPreferences: {
                    'theme--team_1': {
                        ...
                        name: 'team_1',
                        user_id: 'current_user_id',
                        value: JSON.stringify(Preferences.THEMES.xeniaDark),
                    },
                },
            },
            teams: {
    ...
    test('saveTheme for a specific team', async () => {
        ...
        await testStore.dispatch(UserActions.saveTheme(currentTeamId, Preferences.THEMES.xeniaDark));
        expect(testStore.getActions()).toEqual(expectedActions);
    });
    ...
    test('saveTheme for a all teams', async () => {
        ...
        await testStore.dispatch(UserActions.saveTheme('', Preferences.THEMES.xeniaDark));
        expect(testStore.getActions()).toEqual(expectedActions);
    });
});
