...
describe('Markdown', () => {
    ...
    const inlineImage1 = `<h3 class="markdown__heading">In-line Images</h3><p>Xenia/platform build status:  <a class="theme markdown__link" href="https://travis-ci.org/xenia/platform" rel="noreferrer" target="_blank"><img alt="Build Status" class="markdown-inline-img" src="${baseUrl}/api/v4/image?url=https%3A%2F%2Ftravis-ci.org%2Fxenia%2Fplatform.svg%3Fbranch%3Dmaster"></a></p>`;
