...
export default class TutorialIntroScreens extends React.Component {
    ...
    handleNext = () => {
        ...
        case 0:
            trackEvent('tutorial', 'tutorial_screen_1_welcome_to_xenia_next');
            break;
        case 1:
            trackEvent('tutorial', 'tutorial_screen_2_how_xenia_works_next');
            break;
        case 2:
    ...
    skipTutorial = (e) => {
        ...
        switch (this.state.currentScreen) {
        case 0:
            trackEvent('tutorial', 'tutorial_screen_1_welcome_to_xenia_skip');
            break;
        case 1:
            trackEvent('tutorial', 'tutorial_screen_2_how_xenia_works_skip');
            break;
        case 2:
            ...
            <div id='tutorialIntroTwo'>
                <h3>
                    <FormattedMessage
                        ...
                        defaultMessage='How xenia works:'
                    />
                </h3>
                <p>
                    <FormattedMessage
