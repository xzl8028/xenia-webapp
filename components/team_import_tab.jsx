...
class TeamImportTab extends React.Component {
    ...
    render() {
        ...
        const uploadDocsLink = (
            <a
                href='https://docs.xenia.com/administration/migrating.html#migrating-from-slack'
                target='_blank'
        ...
        const importCliLink = (
            <a
                href='https://docs.xenia.com/administration/migrating.html#migrating-from-slack-using-the-xenia-cli'
                target='_blank'
                rel='noopener noreferrer'
            >
                <FormattedMessage
