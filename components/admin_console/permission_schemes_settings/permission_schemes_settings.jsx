...
export default class PermissionSchemesSettings extends React.PureComponent {
    ...
    teamOverrideSchemesMigrationView = () => {
        ...
        const docLink = (
            <a
                href='https://docs.xenia.com/administration/config-settings.html#jobs'
        ...
        return (
            <div className='wrapper--fixed'>
                    ...
                    <div className='banner__content'>
                        <span>
                            <FormattedMarkdownMessage
                                ...
                                defaultMessage='Permission Schemes set the default permissions for Team Admins, Channel Admins and everyone else. Learn more about permission schemes in our [documentation](!https://about.xenia.com/default-advanced-permissions).'
                            />
                        </span>
                    </div>
                </div>
                ...
                <AdminPanelWithLink
                    ...
                    subtitleDefault='Set the default permissions inherited by all teams unless a [Team Override Scheme](!https://about.xenia.com/default-team-override-scheme) is applied.'
                ...
                <AdminPanelWithLink
                    ...
                    subtitleDefault='Use when specific teams need permission exceptions to the [System Scheme](!https://about.xenia.com/default-system-scheme).'
