        ...
        if (this.state.exportFormat === exportFormats.EXPORT_FORMAT_GLOBALRELAY) {
            ...
            const globalRelayEmail = (
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.complianceExport.globalRelayEmailAddress.example', 'E.g.: "globalrelay@xenia.com"')}
                    helpText={
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMarkdownMessage
                            ...
                            defaultMessage='When true, Xenia will export all messages that were posted in the last 24 hours. The export task is scheduled to run once per day. See [the documentation](!https://about.xenia.com/default-compliance-export-documentation) to learn more.'
                        />
                    }
