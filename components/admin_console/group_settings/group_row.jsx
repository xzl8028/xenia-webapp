...
export default class GroupRow extends React.Component {
    static propTypes = {
        ...
        xenia_group_id: PropTypes.string,
    ...
    renderActions = () => {
        if (!this.props.xenia_group_id) {
            return null;
        }
        if (this.props.has_syncables) {
            return (
                <Link to={'/admin_console/user_management/groups/' + this.props.xenia_group_id}>
                    <FormattedMessage
