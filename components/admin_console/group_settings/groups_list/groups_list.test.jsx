...
describe('components/admin_console/group_settings/GroupsList', () => {
    ...
    test('should match snapshot, with only linked selected', () => {
        const wrapper = shallow(
            <GroupsList
                groups={[
                    {primary_key: 'test1', name: 'test1', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test2', name: 'test2', xenia_group_id: 'group-id-1', has_syncables: false},
                ]}
                total={2}
                actions={{
                    getLdapGroups: jest.fn().mockReturnValue(Promise.resolve()),
        ...
        const wrapper = shallow(
            <GroupsList
                groups={[
                    {primary_key: 'test1', name: 'test1', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test2', name: 'test2', xenia_group_id: 'group-id-1', has_syncables: false},
                    {primary_key: 'test3', name: 'test3', xenia_group_id: 'group-id-1', has_syncables: false},
                    {primary_key: 'test4', name: 'test4', xenia_group_id: null, has_syncables: null},
                ]}
                total={4}
                actions={{
                    getLdapGroups: jest.fn().mockReturnValue(Promise.resolve()),
        ...
        const wrapper = shallow(
            <GroupsList
                groups={[
                    {primary_key: 'test1', name: 'test1', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test2', name: 'test2', xenia_group_id: 'group-id-1', has_syncables: false},
                    {primary_key: 'test3', name: 'test3', xenia_group_id: 'group-id-2', has_syncables: true},
                ]}
                total={3}
                actions={{
                    getLdapGroups: jest.fn().mockReturnValue(Promise.resolve()),
        ...
        const wrapper = shallow(
            <GroupsList
                groups={[
                    ...
                    {primary_key: 'test3', name: 'test3', xenia_group_id: 'group-id-2', has_syncables: true},
                    {primary_key: 'test4', name: 'test4', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test5', name: 'test5', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test6', name: 'test6', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test7', name: 'test7', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test8', name: 'test8', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test9', name: 'test9', xenia_group_id: null, has_syncables: null},
                    {primary_key: 'test10', name: 'test10', xenia_group_id: null, has_syncables: null},
                ]}
                total={33}
                actions={{
                    getLdapGroups: jest.fn().mockReturnValue(Promise.resolve()),
