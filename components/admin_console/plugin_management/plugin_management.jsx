...
import PluginState from 'xenia-redux/constants/plugins';
        ...
        if (enableUploads && enable) {
            ...
            uploadHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Enable plugin uploads in config.json. See [documentation](!https://about.xenia.com/default-plugin-uploads) to learn more.'
                />
            );
        } else {
            uploadHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='To enable plugins, set **Enable Plugins** to true. See [documentation](!https://about.xenia.com/default-plugin-uploads) to learn more.'
                />
            );
        }
