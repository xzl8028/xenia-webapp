        ...
        if (this.state.pushNotificationServerType === PUSH_NOTIFICATIONS_OFF) {
            sendHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Please see [documentation on push notifications](!https://about.xenia.com/default-mobile-push-notifications/) to learn more about setup options.'
                />
            );
            ...
            pushServerHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Learn more about compiling and deploying your own mobile apps from an [Enterprise App Store](!https://about.xenia.com/default-enterprise-app-store).'
                />
            );
        }
        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.email.pushServerEx', 'E.g.: "https://push-test.xenia.com"')}
