                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://docs.xenia.com/deployment/sso-google.html'}
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://docs.xenia.com/deployment/sso-office.html'}
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://docs.xenia.com/deployment/sso-gitlab.html'}
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            values={{
                                link: (
                                    <ErrorLink
                                        url={'https://forum.xenia.org/c/trouble-shoot'}
