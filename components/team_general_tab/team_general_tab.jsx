                    ...
                    <div key='userOpenInviteOptions'>
                        <div>
                            <FormattedMarkdownMessage
                                ...
                                defaultMessage='No, members of this team are added and removed by linked groups. [Learn More](https://xenia.com/pl/default-ldap-group-constrained-team-channel.html)'
                            />
                        </div>
                    </div>,
                ];
                ...
                >
                    <div className='col-sm-12'>
                        <LocalizedInput
                            ...
                            onFocus={Utils.moveCursorToEnd}
                            placeholder={{id: t('general_tab.AllowedDomainsExample'), defaultMessage: 'corp.xenia.com, xenia.org'}}
                        />
                    </div>
                </div>
            );

            const allowedDomainsInfo = <span>{Utils.localizeMessage('general_tab.AllowedDomainsInfo', 'Users can only join the team if their email matches a specific domain (e.g. "xenia.org") or list of comma-separated domains (e.g. "corp.xenia.com, xenia.org").')}</span>;
