            ...
            if (cleanedName.indexOf(Constants.RESERVED_TEAM_NAMES[index]) === 0) {
                this.setState({nameError: (
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='This URL [starts with a reserved word](!https://docs.xenia.com/help/getting-started/creating-teams.html#team-url) or is unavailable. Please try another.'
                    />),
                });
                return;
            }
