                ...
                <div className='banner'>
                    <div className='banner__content'>
                        <FormattedMarkdownMessage
                            ...
                            defaultMessage='Only data for the chosen team is calculated. Excludes posts made in direct message channels, which are not tied to a team. \n \n Some statistics have been omitted because they put too much load on the system to calculate. See [https://docs.xenia.com/administration/statistics.html](!https://docs.xenia.com/administration/statistics.html) for more details.'
                        />
                    </div>
                </div>
            );
