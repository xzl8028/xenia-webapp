            ...
            extraInfo = (
                <span>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='[Personal access tokens](!https://about.xenia.com/default-user-access-tokens) function similarly to session tokens and can be used by integrations to [authenticate against the REST API](!https://about.xenia.com/default-api-authentication). Create new tokens on your desktop.'
                    />
                </span>
            );
        } else {
            extraInfo = (
                <span>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='[Personal access tokens](!https://about.xenia.com/default-user-access-tokens) function similarly to session tokens and can be used by integrations to [authenticate against the REST API](!https://about.xenia.com/default-api-authentication).'
                    />
                </span>
            );
        }
