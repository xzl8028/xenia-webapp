                        ...
                        <div className='row bot-profile__section'>
                            <div className='col-md-5 col-sm-8 col-sm-offset-4'>
                                <FormattedMarkdownMessage
                                    ...
                                    defaultMessage='Select additional permissions for the account. [Read more about roles and permissions](!https://about.xenia.com/default-permissions).'
                                />
                            </div>
                        </div>
                        <div className='form-group'>
                            ...
                            <div className='col-md-5 col-sm-8 checkbox'>
                                ...
                                <div className='form__help'>
                                    <FormattedMessage
                                        ...
                                        defaultMessage='Bot will have access to post to all xenia channels including direct messages.'
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='col-md-5 col-sm-8 checkbox'>
                                ...
                                <div className='form__help'>
                                    <FormattedMessage
                                        ...
                                        defaultMessage='Bot will have access to post to all xenia public channels.'
                                    />
                                </div>
                            </div>
                        </div>
