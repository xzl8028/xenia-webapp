            ...
            helpText = (
                <p>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='Your incoming webhook has been set up. Please send data to the following URL (see [documentation](!https://docs.xenia.com/developer/webhooks-incoming.html) for further details).'
                    />
                </p>
            );
            tokenText = (
            ...
            helpText.push(
                <p key='add_oauth_app.doneHelp'>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='Your OAuth 2.0 application has been set up. Please use the following Client ID and Client Secret when requesting authorization for your application (see [documentation](!https://docs.xenia.com/developer/oauth-2-0-applications.html) for further details).'
                    />
                </p>
            );
            helpText.push(
            ...
            helpText = (
                <p>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='Your bot account **{botname}** has been created successfully. Please use the following access token to connect to the bot (see [documentation](https://xenia.com/pl/default-bot-accounts) for further details).'
                        values={{
