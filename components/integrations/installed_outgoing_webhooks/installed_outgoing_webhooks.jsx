            ...
            <BackstageList
                ...
                helpText={
                    <FormattedMessage
                        ...
                        defaultMessage='Use outgoing webhooks to connect external tools to xenia. {buildYourOwn} or visit the {appDirectory} to find self-hosted, third-party apps and integrations.'
                        values={{
                            buildYourOwn: (
                                <a
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    href='http://docs.xenia.com/developer/webhooks-outgoing.html'
                                >
                                    <FormattedMessage
                            ...
                            appDirectory: (
                                <a
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    href='https://about.xenia.com/default-app-directory/'
                                >
                                    <FormattedMessage
