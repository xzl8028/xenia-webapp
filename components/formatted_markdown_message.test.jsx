...
describe('components/FormattedMarkdownMessage', () => {
    test('should render message', () => {
        const descriptor = {
            id: 'test.foo',
            defaultMessage: '**bold** *italic* [link](https://xenia.com/) <br/> [link target blank](!https://xenia.com/)',
        };
...
export function wrapProvider(el) {
    const enTranslationData = {
        'test.foo': '**bold** *italic* [link](https://xenia.com/) <br/> [link target blank](!https://xenia.com/)',
