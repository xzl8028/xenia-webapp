...
export default function HelpMessaging() {
    return (
        <div>
            ...
            <p>
                <img
                    src='https://docs.xenia.com/_images/replyIcon.PNG'
                    alt='reply arrow'
            ...
            <p>
                <img
                    src='https://docs.xenia.com/_images/messagesTable1.PNG'
                    alt='markdown'
                    className='markdown-inline-img'
                />
            </p>
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage={'**Quickly add emoji** by typing ":", which will open an emoji autocomplete. If the existing emoji don\'t cover what you want to express, you can also create your own [Custom Emoji](!http://docs.xenia.com/help/settings/custom-emoji.html).'}
                />
            </p>
            <p>
                <FormattedMarkdownMessage
