...
export default function HelpFormatting() {
    ...
    return (
        <div>
            ...
            <p>
                <img
                    src='https://docs.xenia.com/_images/syntax-highlighting-github.PNG'
            ...
            <p>
                <img
                    src='https://docs.xenia.com/_images/syntax-highlighting-sol-dark.PNG'
                    alt='go syntax-highlighting'
                    className='markdown-inline-img'
                />
            </p>
            ...
            <p>
                <img
                    src='https://docs.xenia.com/_images/syntax-highlighting-sol-light.PNG'
                    alt='go syntax-highlighting'
                    className='markdown-inline-img'
                />
            </p>
            ...
            <p>
                <img
                    src='https://docs.xenia.com/_images/syntax-highlighting-monokai.PNG'
                    alt='go syntax-highlighting'
                    className='markdown-inline-img'
                />
            </p>
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage={'Open the emoji autocomplete by typing `:`. A full list of emojis can be found [here](!http://www.emoji-cheat-sheet.com/). It is also possible to create your own [Custom Emoji](!http://docs.xenia.com/help/settings/custom-emoji.html) if the emoji you want to use doesn\'t exist.'}
                />
            </p>
