...
import {getChannel, getRedirectChannelNameForTeam} from 'xenia-redux/selectors/entities/channels';
import {getConfig} from 'xenia-redux/selectors/entities/general';
import {getTeammateNameDisplaySetting, getBool} from 'xenia-redux/selectors/entities/preferences';
import {getCurrentUserId, getUser} from 'xenia-redux/selectors/entities/users';
import {
    blendColors,
    changeOpacity,
} from 'xenia-redux/utils/theme_utils';
import {displayUsername} from 'xenia-redux/utils/user_utils';
import {getCurrentTeamId, getCurrentRelativeTeamUrl, getTeam} from 'xenia-redux/selectors/entities/teams';
...
export function applyTheme(theme) {
    ...
    if (theme.sidebarText) {
        changeCss('.app__body .team-sidebar .keyboard-focus, .app__body .sidebar--left .keyboard-focus', 'box-shadow: inset 0 0 1px 3px ' + changeOpacity(theme.sidebarText, 0.5) + ', inset 0 0 0 1px ' + theme.sidebarText);
    ...
    if (theme.dndIndicator) {
        ...
        case 'Organization':
            ...
            break;
        case 'Xenia Dark':
            dndIndicator = Constants.THEMES.xeniaDark.dndIndicator;
            break;
        case 'Windows Dark':
    ...
    if (theme.linkColor) {
        changeCss('.app__body .keyboard-focus', 'box-shadow: inset 0 0 1px 3px ' + changeOpacity(theme.linkColor, 0.5) + ', inset 0 0 0 1px ' + theme.linkColor);
        changeCss('.app__body .post-body__cell.keyboard-focus', 'box-shadow: 0 0 1px 3px ' + changeOpacity(theme.linkColor, 0.5) + ', 0 0 0 1px ' + theme.linkColor);
