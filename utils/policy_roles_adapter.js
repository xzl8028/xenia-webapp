 ...
 * @param {object} roles same structure as returned by xenia-redux `getRoles`.
 * @return {object} the updated roles (only) in the same structure as returned by xenia-redux `getRoles`.
 */
